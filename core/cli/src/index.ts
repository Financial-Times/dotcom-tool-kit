...
import { ScopedMetricsClient } from '@dotcom-tool-kit/telemetry'
...
export async function printMergedOptions(logger: Logger, metrics: ScopedMetricsClient): Promise<void> {
