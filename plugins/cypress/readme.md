...
| `openModeOnLocal` | Determines whether Cypress tests run in the local environment will run in [Open Mode](https://docs.cypress.io/app/core-concepts/open-mode). | `boolean` |
