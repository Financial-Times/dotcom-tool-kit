...
* The following workspace dependencies were updated
  * dependencies
    * @dotcom-tool-kit/husky-npm bumped from ^5.0.4 to ^5.0.5
    * @dotcom-tool-kit/lint-staged bumped from ^5.1.1 to ^5.1.2
    * @dotcom-tool-kit/package-json-hook bumped from ^5.0.4 to ^5.0.5
