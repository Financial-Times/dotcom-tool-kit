...
| `orbDevVersion`    | set this option to use a [development version](https://circleci.com/docs/orbs/use/orb-concepts/#development-orbs) of the Tool Kit CircleCI orb in the generated config                                                                                                                                                                                                                       | `string` (_regex: `/^dev:/`_) |                             |
